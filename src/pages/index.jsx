...
export default function Home() {
	...
	const seoData = {
		title: 'Aleksa Popovic - Minecraft-Add-On Developer Portfolio',
		description:
			'Explore the innovative work of Aleksa Popovic, a passionate Minecraft-Add-On Developer',
	...
	return (
        ...
        <link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>📦</text></svg>" />
			...
			<div style={{ backgroundColor: bgColor, transition: 'background-color 5s' }}>
				<div className={`min-h-screen text-white font-retro ${time.hours >= 6 && time.hours < 18 ? 'bg-opacity-0' : 'bg-opacity-50 bg-gray-900'}`}>
					{showLoadingScreen ? (
						<LoadingScreen />
					) : (
						<>
							...
							<main>
								<ChunkLoadingEffect visibleChunks={visibleChunks}>
									...
									<section id='contact' ref={chunkRef('contact')}>
										<Contact />
									</section>
								</ChunkLoadingEffect>
							</main>
							...
							<div className='fixed bottom-4 right-4 z-50 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4'>
								...
								<MinecraftButton href='https://github.com/PinkMan1g/About-Me/tree/main'>🧍 More</MinecraftButton>
							</div>
