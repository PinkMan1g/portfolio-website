	...
	return (
		<section className='min-h-screen flex items-center justify-center relative overflow-hidden px-4 sm:px-6 lg:px-8'>
			...
			<motion.div {...fadeInUp} className='text-center z-10'>
				...
				>
					<motion.h1
						className='text-4xl sm:text-6xl font-bold mb-4 text-white font-retro'
					...
					<motion.h2
						className='text-2xl sm:text-3xl text-green-400 font-retro'
						initial={{ opacity: 0, y: 20 }}
						animate={{ opacity: 1, y: 0 }}
						transition={{ duration: 0.5, ease: 'easeOut', delay: 0.4 }}
					>
						Minecraft Add-On Developer
					</motion.h2>
					...
					>
						...
						<InventoryItem emoji='🎨' count='32' tooltipText='Readable Code, Reliable Results' />
						<InventoryItem emoji='🚀' count='16' tooltipText="Made by Aleksa Popovic" />
